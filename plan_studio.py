...
<p>Incomplete fields can appear here. Export buttons are enabled only after format checks pass. Source URLs remain inert text.</p><div id="preview-content"></div></aside></div></main>

...
</style></head><body><a class="skip-link" href="#plan-content">Skip to plan content</a><header id="plan-top"><p>Household offline plan</p><h1 id="plan-title">''' + escape(plan["title"]) + '''</h1><p>Region: ''' + escape(plan["region"]) + '''
